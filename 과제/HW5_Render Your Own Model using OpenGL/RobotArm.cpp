...
3. 1.RobotArm폴더에 HW3에서 압축을 풀어 HW3안에 있던 8개의 파일을 복사해서 붙여넣음 + 1871040LYJ.obj/mtl/jpg파일도 복사해서 넣음
4. LearnOpenGL-master\bin\Debug폴더에 HW3안에 있던 8개의 파일을 복사해서 붙여넣음 + 1871040LYJ.obj/mtl/jpg파일도 복사해서 넣음
5. LearnOpenGL-master\CMakeLists.txt수정
...
const char* ourObjectPath = "./1871040LYJ.obj"; // object path를 HW2의 오브젝트로 수정 
...
void myDisplay()
{
    ...
    //scale down + tlanslate
    glm::mat4 objectXform = glm::scale(glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.03f, 0.0f)), glm::vec3(0.001f, 0.001f, 0.001f));
    //똑바로 보이게 rotate
    objectXform = glm::rotate(objectXform, 180 * PI / 180 , glm::vec3(0.0f, 0.0f, 1.0f));
    //draw object
